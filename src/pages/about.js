      ...
      <div className={style.post}>
        <div className={style.postContent}>
          ...
          <h3>Meet the host</h3>
            ...
            <p>
              <strong>2. Suggest a Guest!</strong>- Do you think you or someone you know would make an interesting  guest on the show? Maybe you have artistic, creative or entertaining friends who'd have interesting stories to share and work they want to promote? or maybe you are involved in an interesting project that is trying to make your community or the world a better place that we should all be hearing about? <Link to="/contact">Get in touch</Link> and tell me more.
            </p>
